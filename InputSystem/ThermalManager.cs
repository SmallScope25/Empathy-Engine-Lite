...
namespace UniversalFramework.ThermalManagement
{
    ...
    public class ThermalMonitor : MonoBehaviour
    {
        ...
        void UpdatePerformanceMetrics()
        {
            ...
            currentMetrics.memoryUsageMB = UnityEngine.Profiling.Profiler.GetTotalAllocatedMemoryLong() / (1024f * 1024f);
    ...
    public abstract class ThermalAwareComponent : MonoBehaviour
    {
        ...
        void Start()
        {
            thermalMonitor = FindFirstObjectByType<ThermalMonitor>();
